...
<header class="p-3 bg-dark text-white">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="text-end">
                <a href="/controller?command=CHANGE_LANGUAGE&language=en_US"><button class="btn btn-outline-light" type="submit">En/Ru</button></a>
    ...
    <article class="my-3" id="images">
        <div class="bd-example">
            <svg class="bd-placeholder-img bd-placeholder-img-lg img-fluid" width="100%" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Responsive image" preserveAspectRatio="xMidYMid slice" focusable="false">
                ...
                <text x="50%" y="50%" fill="#dee2e6" dy=".3em">Responsive image</text></svg>
