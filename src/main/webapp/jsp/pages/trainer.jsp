...
<fmt:message key="trainer.name" var="trainer_name"/>
<fmt:message key="trainer.contacts" var="contacts"/>
<fmt:message key="trainer.language" var="lang"/>
<fmt:message key="trainer.main" var="main"/>
<fmt:message key="trainer.sign_in" var="sign_in"/>
<fmt:message key="trainer.registration" var="registration"/>
<fmt:message key="trainer.pricing" var="pricing"/>
<fmt:message key="trainer.trainer" var="trainer"/>
