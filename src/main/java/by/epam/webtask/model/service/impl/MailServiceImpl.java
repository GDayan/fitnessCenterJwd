...
public class MailServiceImpl implements MailService {
    ...
    private static final String MAIL_CONFIG_PATH = "database/mail/config.properties";
    private static final String MAIL_SESSION_CONFIG_PATH = "database/mail/session.properties";
